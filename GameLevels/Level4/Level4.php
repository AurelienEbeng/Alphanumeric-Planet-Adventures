...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['refresh'])) {
        ...
        if (checkDescendingNumbers($input)) { 
            header("Location: ../Msn/congratulations4.php");
            exit();
        } else {
            $message = "Numbers are not in descending order. Please try again.";
            $_SESSION['lives']--;
...
<body>
    <div class="navbar" style = "padding-bottom: 20px; padding-top: 20px; margin-bottom: 0px;"">
        <a href="history4.php" class="navbar__button">Last Scores</a>        
    </div>
    <div class="login">    
        <form action="" method="post" class="login__form" id="loginForm">
            <div><h1>Number Game  Level 4</h1></div>  
            <p style = "color: black;" >Arrange the numbers in descending order:</p>
            <div>
                <br>
                <label for="letters" style = "color: black;" >Random Numbers:</label>
